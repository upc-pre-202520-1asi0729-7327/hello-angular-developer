 ...
 * Collects first name and last name of the developer.
 *
 * @remarks
 * - Uses Angular Signals for state management.
 * - Emits events for registration and deferral actions.
 */
@Component({
...
export class DeveloperRegistration {
  ...
  public submitRegistrationRequest(): void {
    if (this.isFormValid()) this.developerRegistered.emit({firstName: this.firstName(), lastName: this.lastName()});
    this.clearFields();
  }
